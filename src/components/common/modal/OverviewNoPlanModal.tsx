...
const OverviewNoPlanModal = ({
  ...
  return (
    ...
    >
      <div className="relative  w-full max-w-[304px] max-h-[241px] mx-auto">
        <div className="relative bg-white rounded-lg shadow pt-5">
          ...
          <div className="flex flex-col justify-between">
            <div className="flex flex-col w-full items-center text-center gap-[8px] py-[20px] px-[12px] ">
              <svg
                width="40"
                height="40"
                viewBox="0 0 40 40"
              ...
              <p className="text-sm text-[#717274] font-normal w-full md:w-[264px]">
                {/* Please kindly purchase a plan to apply on{' '}
                <b className="capitalize">{paltform}</b> */}
                To use this feature, kindly subscribe to a plan that has what
                you need
              </p>
            </div>
            <div className="flex items-center justify-center w-full bg-[#A8A8AB14] border-t border-[#E5E6EC] px-[20px] py-[12px]">
              <button
                type="button"
                onClick={handlePurchaseAPlan}
                className="bg-[#131D26] px-[20px] py-[10px] rounded-[4px] text-sm text-[#F6D155] font-medium w-full max-w-[264px]"
              >
                Purchase Plan
              </button>
            </div>
...
export default OverviewNoPlanModal;
