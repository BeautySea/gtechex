...
const FreePlanResumeUploadLimit = ({ toggleModal }: upgradeProps) => {
  return (
    <div
      id="popup-modal"
      tabIndex={-1}
          ...
          <div className="flex flex-col justify-between">
            <div className="flex flex-col w-full items-center text-center gap-[8px] py-[20px] px-[12px] ">
              ...
              <p className="text-sm text-[#717274] font-normal w-full md:w-[264px]">
                Please kindly purchase a plan to continue
              </p>
            </div>
            <div className="flex items-center justify-center w-full bg-[#A8A8AB14] border-t border-[#E5E6EC] py-[20px] px-[12px]">
              <button
                type="button"
                onClick={toggleModal}
                className="bg-[#131D26] px-[20px] py-[10px] rounded-[4px] text-sm text-[#F6D155] font-medium w-[90%]"
              >
                Purchase Plan
              </button>
            </div>
...
export default FreePlanResumeUploadLimit;
