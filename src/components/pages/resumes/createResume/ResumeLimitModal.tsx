...
const ResumeLimitModal = ({ toggleModal }: upgradeProps) => {
  return (
    <div
      id="popup-modal"
      tabIndex={-1}
      ...
      <div className="relative  w-full max-w-md max-h-full mx-auto">
        <div className="relative bg-white rounded-lg shadow pt-5">
          ...
          <div className="flex flex-col justify-between">
            <div className="flex flex-col w-full items-center text-center gap-[16px] py-[20px] px-[12px] ">
              <svg
                width="40"
                height="40"
                viewBox="0 0 40 40"
              ...
              <p className="text-base text-[#131D26] font-semibold leading-6 w-full md:w-[264px]">
                Sorry, you have exhausted your resume limit of 5
              </p>
            </div>
            <div className="flex items-center justify-center w-full bg-[#A8A8AB14] border-t border-[#E5E6EC] py-[20px] px-[12px]">
              <button
                type="button"
                onClick={toggleModal}
                className="bg-[#131D26] py-[20px] rounded-[4px] text-sm text-[#F6D155] font-medium w-[80%]"
              >
                Okay!
              </button>
            </div>
