    ...
    >
      <div className="relative  w-full max-w-md max-h-full mx-auto">
        <div className="relative bg-white rounded-lg shadow p-4">
          <div className="w-full flex items-center justify-between pl-4">
            <div className="flex flex-col gap-[4px]">
              <h3 className="text-base text-[#131D26] font-semibold">
                {upgradeTo ? upgradeTo : 'Upgrade to Standard'}
              </h3>
          ...
          <div className="p-4 md:p-5 border-t-2 lg:h-[58px]">
            <Link to="#">
              <ButtonRounded
                type="button"
                ...
                text={upgradeTo ? upgradeTo : 'Upgrade to Standard'}
              />
            </Link>
          </div>
        </div>
...
export default UpgradeToStandardModal;
